...
const DEMO_DATABASE: DemoReference[] = [
  {
    ...
    resolved: { provider: 'youtube', thumbnailUrl: 'https://i.ytimg.com/vi/zqNTltOGh5c/mqdefault.jpg', youtubeVideoId: 'zqNTltOGh5c' },
  },
  {
    textSpan: 'A Love Supreme',
    type: 'music',
    entity: { title: 'A Love Supreme', creator: 'John Coltrane', kind: 'album', year: 1965 },
    resolved: { provider: 'youtube', thumbnailUrl: 'https://i.ytimg.com/vi/vMCHDC2Lurk/mqdefault.jpg', youtubeVideoId: 'vMCHDC2Lurk' },
  },
  {
    textSpan: 'Like a Rolling Stone',
    type: 'music',
    entity: { title: 'Like a Rolling Stone', creator: 'Bob Dylan', kind: 'song', year: 1965 },
    resolved: { provider: 'youtube', thumbnailUrl: 'https://i.ytimg.com/vi/IwOfCgkyEj0/mqdefault.jpg', youtubeVideoId: 'IwOfCgkyEj0' },
  },
  {
    textSpan: 'Bohemian Rhapsody',
    type: 'music',
    entity: { title: 'Bohemian Rhapsody', creator: 'Queen', kind: 'song', year: 1975 },
    resolved: { provider: 'youtube', thumbnailUrl: 'https://i.ytimg.com/vi/fJ9rUzIMcZQ/mqdefault.jpg', youtubeVideoId: 'fJ9rUzIMcZQ' },
  },
  {
    ...
    resolved: { provider: 'youtube', thumbnailUrl: 'https://i.ytimg.com/vi/4Tr0otuiQuU/mqdefault.jpg', youtubeVideoId: '4Tr0otuiQuU' },
  },
  {
    textSpan: 'Imagine',
    type: 'music',
    entity: { title: 'Imagine', creator: 'John Lennon', kind: 'song', year: 1971 },
    resolved: { provider: 'youtube', thumbnailUrl: 'https://i.ytimg.com/vi/YkgkThdzX-8/mqdefault.jpg', youtubeVideoId: 'YkgkThdzX-8' },
  },
  {
    textSpan: 'Clair de Lune',
    type: 'music',
    entity: { title: 'Clair de Lune', creator: 'Claude Debussy', kind: 'performance', year: 1905 },
    resolved: { provider: 'youtube', thumbnailUrl: 'https://i.ytimg.com/vi/CvFH_6DNRCY/mqdefault.jpg', youtubeVideoId: 'CvFH_6DNRCY' },
  },
  {
  ...
  },
  {
    ...
    resolved: { provider: 'youtube', thumbnailUrl: 'https://i.ytimg.com/vi/BkL9l7qovsE/mqdefault.jpg', youtubeVideoId: 'BkL9l7qovsE' },
  },
  {
    textSpan: 'Citizen Kane',
    type: 'film',
    entity: { title: 'Citizen Kane', creator: 'Orson Welles', kind: 'movie', year: 1941 },
    resolved: { provider: 'youtube', thumbnailUrl: 'https://i.ytimg.com/vi/8dxqKJHmMbA/mqdefault.jpg', youtubeVideoId: '8dxqKJHmMbA' },
  },
  {
    textSpan: '2001: A Space Odyssey',
    type: 'film',
    entity: { title: '2001: A Space Odyssey', creator: 'Stanley Kubrick', kind: 'movie', year: 1968 },
    resolved: { provider: 'youtube', thumbnailUrl: 'https://i.ytimg.com/vi/oR_e9y-bka0/mqdefault.jpg', youtubeVideoId: 'oR_e9y-bka0' },
  },
  {
    textSpan: 'The Godfather',
    type: 'film',
    entity: { title: 'The Godfather', creator: 'Francis Ford Coppola', kind: 'movie', year: 1972 },
    resolved: { provider: 'youtube', thumbnailUrl: 'https://i.ytimg.com/vi/UaVTIH8mujA/mqdefault.jpg', youtubeVideoId: 'UaVTIH8mujA' },
  },
];
